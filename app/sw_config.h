...
#define HAT_SW_MODE_SETUP				HAT_SW_MODE_TEST_CENTRAL
*/



// Definition : PAAR ID(4 Byte)
#define PAAR_ID_0					0x30
#define PAAR_ID_1					0x17
#define PAAR_ID_2					0x33	// 35
#define PAAR_ID_3					0xD8	// d4

#define TEST_TARTGET_PAAR_ID_SIZE	4

#define TEST_TARTGET_PAAR_ID0	0xff
